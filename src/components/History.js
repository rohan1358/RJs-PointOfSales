...
class list extends Component {
  ...
  listHistory = async () => {
    Axios.get("http://54.157.181.233:8012/api/v1/order");
  };
  componentDidMount() {
    ...
    Axios.get("http://54.157.181.233:8012/api/v1/order").then((res) => {
      const history = res.data;
      // const history = JSON.parse(story);
      this.setState({ history });
    });
    Axios.get("http://54.157.181.233:8012/api/v1/order/todayIncome").then(
      (res) => {
        const todayIncome = res.data;
        this.setState({ todayIncome });
      }
    );
    Axios.get("http://54.157.181.233:8012/api/v1/order/yearincome").then(
      (res) => {
        const yearIncome = res.data;
        this.setState({ yearIncome });
      }
    );
    Axios.get("http://54.157.181.233:8012/api/v1/order/allorder").then((res) => {
